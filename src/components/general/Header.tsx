...
export default function Header() {
  ...
  return (
    <div className="flex flex-row items-center justify-between bg-[#439775] px-2 lg:px-5 w-[95%] lg:w-[90%] mr-auto ml-auto lg:mr-auto lg:ml-auto max-w-[98vw] min-h-[6vh] rounded-xl mt-3 drop-shadow-[3.55px_3.55px_22.2px_rgba(0,0,0,0.2)] backdrop-blur-[9px]">
      <img
        src={logo}
